/* ==========================================================
   ...
   Controller dành riêng cho nhân viên bán vé trực tiếp.
...
async function _doCompletePayment(paymentInfo) {
    ...
    try {
        ...
        _ticketsLoaded = false; loadAllEvents(); // reset cache vé sau khi bán thành công
 ...
 * Nhận object group { maHoaDon, ngayMua, tenSuKien, thoiGianBatDau,
 *   thoiGianKetThuc, thanhTien, thanhTienGoc, tickets[] }
 */
